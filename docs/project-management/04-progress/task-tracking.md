...
| M0-003 | M0-foundation | 建立 Go/前端 lint、test、Windows build、secret scan | P0 | DONE | M0-002 | PR 必须通过全部门禁 | [Issue #7](https://github.com/vvitem/item_all/issues/7) / [PR #11](https://github.com/vvitem/item_all/pull/11) / `6202722` | 持续维护 required checks |
| M0-004 | M0-foundation | 建立 SQLite WAL、Migration 和 Repository 骨架 | P0 | READY | M0-002,M0-003 | 首次启动迁移成功；重复运行幂等 | [Issue #12](https://github.com/vvitem/item_all/issues/12) | 编写设计 Spec，冻结 Driver/Migration/Repository 边界 |
